...
public class ThreadSafeBankAccount2_3a {
	...
	public ThreadSafeBankAccount2_3a(int accountNumber) {
	...
	public static void main(String[] args) {
		ThreadSafeBankAccount2_3a bankAccount = new ThreadSafeBankAccount2_3a(0);
		ThreadSafeBankAccount2_3a bankAccount2 = new ThreadSafeBankAccount2_3a(1);
		for (int i = 0; i <2; i++) {
