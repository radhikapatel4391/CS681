	...
	public void run() {		
		while(true)
		{
			...
			//try {				
				...
				ac.increment(p);// these two line are not in thread safe version....context switch could happen...
				ac.getCount(p);
			...
			//}
			try {
				System.out.println("going to sleep for 0.3 minute..."+Thread.currentThread().getName());
				Thread.sleep(3000);
